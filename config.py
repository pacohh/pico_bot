...
DISCORD_LOUNGE_CHANNEL_ID = int(env.require('DISCORD_LOUNGE_CHANNEL_ID'))
...
DISCORD_POSTSCRIPTUM_CHANNEL_ID = int(env.require('DISCORD_POSTSCRIPTUM_CHANNEL_ID'))
...
# OpenAI
CHATTER_ASSISTANT_ID = env.require('CHATTER_ASSISTANT_ID')
CHATTER_THREAD_ID = env.require('CHATTER_THREAD_ID')
